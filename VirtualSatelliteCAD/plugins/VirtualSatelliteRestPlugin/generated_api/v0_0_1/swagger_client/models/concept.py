...
class Concept(object):
    ...
    def __init__(self, version=None, description=None, categories=None, is_beta=None, full_qualified_name=None, structural_elements=None, non_abstract_categories=None, _configuration=None):  # noqa: E501
