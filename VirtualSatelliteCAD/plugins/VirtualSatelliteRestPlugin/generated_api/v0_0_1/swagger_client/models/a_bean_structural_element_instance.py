...
class ABeanStructuralElementInstance(object):
    ...
    def __init__(self, uuid=None, super_seis=None, category_assignments=None, children=None, assigned_discipline=None, name=None, parent=None, _configuration=None):  # noqa: E501
